...
namespace Carestream.AdmTramas.Generator.Export.Validador
{
    public class ValidadorLibroVentas
    {
        ...
        private Error Validar(RegistroVenta registroVenta)
        {
            ...
            var Ticket = registroVenta.Ticket;
            ...
            result = _iValidadorRegistroVenta.ValidaTipoDocumento(
            ...
            result = _iValidadorRegistroVenta.ValidaNumeroDocumento(
            ...
            //16. Valor de ticket
            result = _iValidadorRegistroVenta.ValidaTicket(Ticket, TipoDocumento, ImporteTotalComprobante);

            RegistraError(errorDetalle, Ventas.Ticket, result, NumeroLinea);
