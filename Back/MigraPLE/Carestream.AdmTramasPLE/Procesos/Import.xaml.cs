...
namespace Carestream.AdmTramasPLE.Procesos
{
    ...
    public partial class Import : Window
    {
        ...
        private async Task<string> CargarArchivo(Version version,AdmTramas.Model.Entities.Import import)
        {
            var fLibrolog = VersionSelector.GetImport(version);

            var importTask = new Task<string>(() => fLibrolog.GuardarImport(import).Result);
        ...
        private AdmTramas.Model.Entities.Import GeneraLibro()
        {
            ...
            var mes = CmbMes.SelectedValue.ToString();
            var anio = TxtAnio.Text;
            ...
            var import = new AdmTramas.Model.Entities.Import
            {
                ...
                Periodo = Formato.GeneraFecha(anio, mes)
            };
