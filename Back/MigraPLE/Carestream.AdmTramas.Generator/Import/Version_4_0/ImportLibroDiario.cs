...
namespace Carestream.AdmTramas.Generator.Import.Version_4_0
{
    public class ImportLibroDiario : IImportLibroDiario
    {
        ...
        private IEnumerable<LibroDiario> AgrupaCuenta70(IEnumerable<LibroDiario> registros)
        {
            ...
            var sumarizado = (from grupo in cuentas70
                              group grupo by new
                              {
                                  grupo.Fecha,
                                  grupo.CodigoUnico,
            ...
            foreach (var registro in sumarizado)
            {
                diferencia = registro.Debe - registro.Haber;
                ...
                {
                    registro.Haber = (-1) * diferencia;
                    registro.Debe = 0;
                }
            }

            result.AddRange(sumarizado);         
